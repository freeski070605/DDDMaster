...
const siteSettingsSchema = new Schema(
  {
    ...
    instagramSectionEyebrow: { type: String, required: true },
    instagramSectionTitle: { type: String, required: true },
    instagramSectionCopy: { type: String, required: true },
    ...
    testimonialsSupportEyebrow: { type: String, required: true },
    testimonialsSupportTitle: { type: String, required: true },
    testimonialsSupportCopy: { type: String, required: true },
